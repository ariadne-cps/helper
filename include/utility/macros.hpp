...
#ifndef ARIADNE_UTILITY_MACROS_HPP
#define ARIADNE_UTILITY_MACROS_HPP

#include <sstream>
#include <stdexcept>

#define ARIADNE_UTILITY_USING_CONSTRUCTORS(Class,Base) \
...
#define ARIADNE_UTILITY_THROW(except,func,msg)          \
    { \
...
#define ARIADNE_UTILITY_ASSERT(expression) \
    { \
...
#ifndef NDEBUG
#define ARIADNE_UTILITY_DEBUG_ASSERT_MSG(expression,error) \
    { \
        bool assertion_result = static_cast<bool>(expression); \
        if(!assertion_result) { \
...
#ifndef NDEBUG
#define ARIADNE_UTILITY_DEBUG_ASSERT(expression) \
    { \
        bool assertion_result = static_cast<bool>(expression); \
        if(!assertion_result) { \
            UTILITY_THROW(std::runtime_error,__FILE__<<":"<<__LINE__<<": "<<__FUNCTION__,"Assertion `" << #expression << "' failed."); \
...
#define ARIADNE_UTILITY_PRECONDITION_MSG(expression,error)             \
    { \
        bool assertion_result = static_cast<bool>(expression); \
        if(!assertion_result) { \
...
#define ARIADNE_UTILITY_PRECONDITION(expression)             \
    { \
        bool assertion_result = static_cast<bool>(expression); \
        if(!assertion_result) { \
            UTILITY_THROW(std::runtime_error,__FILE__<<":"<<__LINE__<<": "<<UTILITY_PRETTY_FUNCTION,"Precondition `" << #expression << "' failed."); \
...
#ifndef NDEBUG
#define ARIADNE_UTILITY_DEBUG_PRECONDITION(expression) \
    { \
...
#define ARIADNE_UTILITY_ASSERT_EQUAL(expression1,expression2)    \
    { \
...
#define ARIADNE_UTILITY_NOT_IMPLEMENTED                 \
    throw std::runtime_error(StringType("Not implemented: ")+UTILITY_PRETTY_FUNCTION);

#define ARIADNE_UTILITY_DEPRECATED(fn,msg)          \
...
#define ARIADNE_UTILITY_NOTIFY(msg)          \
    {                                                                \
        std::cerr << "NOTIFICATION: " << msg << "" << std::endl;                \
    }

#define ARIADNE_UTILITY_WARN(msg)          \
    {                                                                \
        std::cerr << "WARNING: " << msg << "" << std::endl;                \
    }

#define ARIADNE_UTILITY_WARN_ONCE(msg)          \
    static bool first_time=true; \
    if(first_time) { \
        first_time=false; \
        std::cerr << "WARNING: " << msg << "" << std::endl; \
...
#define ARIADNE_UTILITY_ERROR(msg)          \
    {                                                                \
        std::cerr << "ERROR: " << msg << "" << std::endl;                \
    }
                                                                  \
#if defined(linux) || defined(__linux) || defined(__linux__)
#define ARIADNE_UTILITY_PRETTY_FUNCTION __PRETTY_FUNCTION__
#elif defined(_WIN32) || defined(__WIN32__) || defined(WIN32)
#define ARIADNE_UTILITY_PRETTY_FUNCTION __FUNCTION__
#elif defined(darwin) || defined(__darwin) || defined(__darwin__) || defined(__APPLE__)
#define ARIADNE_UTILITY_PRETTY_FUNCTION __PRETTY_FUNCTION__
#else
#define ARIADNE_UTILITY_PRETTY_FUNCTION ""
#endif


#endif // ARIADNE_UTILITY_MACROS_HPP
