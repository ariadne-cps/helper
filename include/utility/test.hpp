...
#ifndef ARIADNE_UTILITY_TEST_HPP
#define ARIADNE_UTILITY_TEST_HPP
...
#define ARIADNE_UTILITY_TEST_CLASS(classname,testclassconstruct)                       \
    { \
        std::cout << "****************************************\n"       \
...
#define ARIADNE_UTILITY_PRINT_TEST_CASE_TITLE( pTitle )                         \
    {                                                                   \
...
#define ARIADNE_UTILITY_PRINT_TEST_COMMENT( pComment )                          \
    {                                                                   \
...
#define ARIADNE_UTILITY_TEST_WARN( message )                                    \
    {                                                                   \
...
#define ARIADNE_UTILITY_TEST_NOTIFY( message )                                    \
    {                                                                   \
...
#define ARIADNE_UTILITY_TEST_CATCH(message)                                     \
...
#define ARIADNE_UTILITY_TEST_CALL(function)                                     \
    {                                                                   \
        std::cout << "****************************************\n"       \
                  << "CALLING " << #function << "\n"                    \
                  << "****************************************\n" << std::endl; \
...
#define ARIADNE_UTILITY_TEST_SKIP(function)                                     \
    {                                                                   \
        std::cout << "****************************************\n"       \
                  << "SKIPPING " << #function << "\n"                   \
                  << "****************************************\n" << std::endl; \
...
#define ARIADNE_UTILITY_TEST_EXECUTE(statement)                                 \
    {                                                                   \
...
#define ARIADNE_UTILITY_TEST_TRY(statement)                                     \
    {                                                                   \
        std::cout << #statement << ": " << std::flush;                  \
        try {                                                           \
            statement;                                                  \
...
#define ARIADNE_UTILITY_TEST_PRINT(expression)                                  \
    {                                                                   \
...
#define ARIADNE_UTILITY_TEST_EVALUATE(expression)                               \
    {                                                                   \
        std::cout << #expression << ": " << std::flush;                 \
        try {                                                           \
            std::cout << (expression) << "\n" << std::endl;             \
...
#define ARIADNE_UTILITY_TEST_ASSERT(expression)                                 \
    {                                                                   \
        std::cout << #expression << ": " << std::flush;                 \
...
#define ARIADNE_UTILITY_TEST_CHECK_WARN(expression,expected)                         \
    {                                                                   \
        std::cout << #expression << ": " << std::flush; \
...
/*! \brief Evaluates \a expression and checks if the result is equal to \a expected. */
#define ARIADNE_UTILITY_TEST_CHECK(expression,expected)                         \
    {                                                                   \
        std::cout << #expression << ": " << std::flush; \
        bool ok = testing_check(std::cout,expression,expected);         \
        if(ok) {                                                        \
...
#define ARIADNE_UTILITY_TEST_SAME(expression1,expression2)                         \
    {                                                                   \
...
#define ARIADNE_UTILITY_TEST_SAME_AS(expression,expected)                         \
    {                                                                   \
...
/*! \brief Evaluates \a expression1 and expression2 and checks if the results are equal. */
#define ARIADNE_UTILITY_TEST_EQUAL(expression1,expression2)                         \
    {                                                                   \
...
#define ARIADNE_UTILITY_TEST_NOT_EQUAL(expression1,expression2)                 \
    {                                                                   \
        std::cout << #expression1 << " != " << #expression2 << ": " << std::flush; \
        bool ok = (expression1) == (expression2);               \
        if(ok) {                                                        \
...
/*! \brief Evaluates \a expression and checks if the result is equal to \a expected. */
#define ARIADNE_UTILITY_TEST_EQUALS(expression,expected)                         \
    {                                                                   \
        std::cout << #expression << " == " << #expected << ": " << std::flush; \
...
#define ARIADNE_UTILITY_TEST_WITHIN(expression,expected,tolerance)                         \
    {                                                                   \
        std::cout << #expression << " ~ " << #expected << ": " << std::flush; \
...
#define ARIADNE_UTILITY_TEST_LESS(expression,expected)                         \
    {                                                                   \
        std::cout << #expression << " < " << #expected << ": " << std::flush; \
        bool ok = (expression) < (expected);                       \
        if(ok) {                                                        \
...
#define ARIADNE_UTILITY_TEST_UNARY_PREDICATE(predicate,argument)    \
    {                                                                   \
...
#define ARIADNE_UTILITY_TEST_BINARY_PREDICATE(predicate,argument1,argument2)    \
    {                                                                   \
...
#define ARIADNE_UTILITY_TEST_COMPARE(expression,comparison,expected)           \
    {                                                                   \
...
#define ARIADNE_UTILITY_TEST_RESULT_COMPARE(Type,expression,comparison,expected) \
    {                                                                   \
...
#define ARIADNE_UTILITY_TEST_DECLARE(Class,variable)                            \
    {                                                                   \
...
#define ARIADNE_UTILITY_TEST_CONSTRUCT(Class,variable,expression)               \
    std::cout << #Class << " " << #variable << "" << #expression << ": " << std::flush; \
    Class variable expression;                                          \
    std::cout << #variable << "==" << variable << "\n" << std::endl;    \

/*! \brief Constructs default object \a variable of type \a Class. */
#define ARIADNE_UTILITY_TEST_DEFAULT_CONSTRUCT(Class,variable)               \
    std::cout << #Class << " " << #variable << ": " << std::flush; \
    Class variable;                                                \
    std::cout << #variable << "==" << (variable) << "\n" << std::endl;    \
...
/*! \brief Constructs object \a variable of type \a Class from \a expression. */
#define ARIADNE_UTILITY_TEST_NAMED_CONSTRUCT(Class,variable,expression)               \
    {                                                                   \
...
#define ARIADNE_UTILITY_TEST_ASSIGN_CONSTRUCT(Class,variable, expression)       \
    {                                                                   \
        std::cout << #Class << " " << #variable << " = " << #expression << ": " << std::flush; \
        try {                                                           \
            Class variable = expression;                                \
...
#define ARIADNE_UTILITY_TEST_ASSIGN(variable, expression)                       \
    {                                                                   \
...
#define ARIADNE_UTILITY_TEST_THROWS(statement,error)                             \
    {                                                                   \
        std::cout << #statement << ": " << std::flush;                  \
        try {                                                           \
            statement;                                                  \
...
/*! \brief Evaluates expression and expects an exception. */
#define ARIADNE_UTILITY_TEST_FAIL(statement)                                    \
    {                                                                   \
        std::cout << #statement << ": " << std::flush;                  \
        try {                                                           \
            statement;                                                  \
...
#define ARIADNE_UTILITY_TEST_STATIC_ASSERT(...)                          \
    {                                                                   \
...
/*! Use variadic macro argument to allow template parameters */
#define ARIADNE_UTILITY_TEST_CONCEPT(...)                          \
    {                                                                   \
        std::cout << #__VA_ARGS__ << ": " << std::flush;                 \
...
/*! \brief Evaluates \a expression in a boolean context and checks if the result is \a true. */
/*! Use variadic macro argument to allow template parameters */
#define ARIADNE_UTILITY_TEST_SAME_TYPE(...)                          \
    {                                                                   \
...
/*! Use variadic macro argument to allow template parameters */
#define ARIADNE_UTILITY_TEST_EQUIVALENT_TYPE(...)                          \
    {                                                                   \
 ...
 */
#define ARIADNE_UTILITY_TEST_GRID_TREE_SUBPAVING_ITERATOR( expected_result, theGridTreeSubpaving, expected_number_elements ) \
    {                                                                   \
...
#define ARIADNE_UTILITY_CLEAN_TEST_VECTOR( vector ) \
    { \
...
#endif // ARIADNE_UTILITY_TEST_HPP
